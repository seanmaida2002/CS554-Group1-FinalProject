...
function EditProfileModal(props) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (image) {
                if (profile.imageUrl) {
                    const user = await axios.get(`http://3.15.141.91:3000/user/${auth.currentUser.uid}`)
            ...
            const update = await axios.patch(`http://3.15.141.91:3000/user/${firebaseUid}`, updateProfile);
